...
func _ready() -> void:
	...
	for i in [3, 5, 20, 21, 24, 28, 30, 37, 39, 41, 44, 47, 66, 118, 127, 136, 146, 153, 161, 163]:
		is_fluid[i] = true
	for i in [1, 11, 12, 16, 42, 4, 8, 23, 31, 32, 33, 49, 63, 64, 45, 70, 72, 75, 85, 95, 98, 119, 128, 130, 162, 159, 157, 164]:
		is_powder[i] = true
