#ifndef MUSHROOM_CORE_H
#define MUSHROOM_CORE_H

#include "../element.h"

class MushroomCore: public Element {
public:
    const double DECAY = 1.0 / 1024;
    const double GERMINATE = 1.0 / 4096;
    const double FLAME = 1.0 / 48;
    const double POWDER = 1 / 2.0;
